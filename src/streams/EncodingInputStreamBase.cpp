...
std::string EncodingInputStreamBase::detectCharset(char * buf, size_t size)
{
    csd_t csd = csd_open();
...
bool EncodingInputStreamBase::read(std::string & data, size_t max_size)
{
...
bool EncodingInputStreamBase::eof() const
{
    return inner_eof() && buffer_filled_length == 0;
}
}
